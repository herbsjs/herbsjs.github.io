...
In this tutorial we are going to walk throught all the features from Herbs, building a To-do list application.
...
You can also set up the file by your own. To help you on that we have a [extension for VS Code](https://marketplace.visualstudio.com/items?itemName=EndersonCosta.herbs-snippets) with code snippets and templates.
