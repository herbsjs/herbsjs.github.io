---
id: herbs2rest-legacy
title: REST - Herbs2REST (Legacy)
sidebar_label: REST Legacy
slug: /glues/herbs2rest-legacy
---

:::caution
This documentation is for the legacy version of Herbs2REST. If you are starting a new project, we recommend using the [new version](/docs/glues/herbs2rest).
:::
